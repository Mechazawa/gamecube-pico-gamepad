...
#define controller_pio_version 0
...
static const uint16_t controller_program_instructions[] = {
    ...
    0x17e5, //  7: jmp    !osre, 5        side 0 [7]
    0x030b, //  8: jmp    11                     [3]
    0x07e5, //  9: jmp    !osre, 5               [7]
    0x130b, // 10: jmp    11              side 0 [3]
    0xbb42, // 11: nop                    side 1 [3]
    0xb042, // 12: nop                    side 0
    0xe027, // 13: set    x, 7
    0x2720, // 14: wait   0 pin, 0               [7]
    0x4001, // 15: in     pins, 1
...
static const struct pio_program controller_program = {
    ...
    .length = 19,
    .origin = -1,
    .pio_version = controller_pio_version,
